...
2. Follow `/Users/venm3/Desktop/Ven AI/CLAUDE.md` and the Claude/Cass role it
   assigns.
...
- Inspect `git diff --cached` before every commit. Prefix Claude commits with
  `Cass:`.
